...
DEFAULT_ORDER = ["openai", "groq", "cerebras", "openrouter", "ollama", "gemini", "nvidia", "github"]
...
TIER_TO_ORDER = {
    "TINY":  ["openai", "groq", "cerebras", "openrouter", "nvidia", "gemini", "ollama"],
    "LARGE": ["openai", "groq", "cerebras", "openrouter", "ollama", "nvidia", "gemini"],
    "HUGE": ["openai", "groq", "cerebras", "openrouter", "ollama", "nvidia", "gemini"],
...
async def chat(req: ChatRequest):
    ...
    if req.agent and not req.provider:
        pinned = AGENT_ROUTING.get(req.agent) or AGENT_ROUTING.get("default")
